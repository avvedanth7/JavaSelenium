...
public class MethodOverloadingDemo2 {
	...
	{
		System.out.println("login with username  is successfull");
	}
	
	void loginPage(String name,String password)
	{
		System.out.println("login with username  password is successfull");
	}
	
	void loginPage(String name,String password,int key)
	{
		System.out.println("login with username password and key is successfull");
	}
